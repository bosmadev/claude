    ...
    if sys.platform == "win32":
        try:
            ...
            if result.returncode == 0:
                ...
                print(f"  Install with: python C:\\Users\\Dennis\\.claude\\scripts\\install-token-timer.py")
...
def cmd_help() -> None:
    ...
    print("Options:")
    if sys.platform == "win32":
        print("  --all       Sync to all repos (searches ~/Desktop, ~/code, C:\\Users\\Dennis\\.claude, etc.)")
    else:
